...
public class RecombinationPartialMapped extends Recombination {
    ...
    private void create_Segments(int cutPoint1, int cutPoint2, Individual ind1, Individual ind2) {
    ...
    public void crossOver(int[] offspring, Individual ind) {
        if (offspring == child1) {
